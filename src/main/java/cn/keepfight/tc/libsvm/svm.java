...
abstract class Kernel extends QMatrix {
	private cn.keepfight.tc.libsvm.svm_node[][] x;
	...
	{
		do {
			cn.keepfight.tc.libsvm.svm_node[] _=x[i]; x[i]=x[j]; x[j]=_;} while(false);
	...
	Kernel(int l, cn.keepfight.tc.libsvm.svm_node[][] x_, svm_parameter param)
	{
		...
		x = (cn.keepfight.tc.libsvm.svm_node[][])x_.clone();
	...
	static double dot(cn.keepfight.tc.libsvm.svm_node[] x, cn.keepfight.tc.libsvm.svm_node[] y)
	{
		double sum = 0;
		int xlen = x.length;
		int ylen = y.length;
	...
	static double k_function(cn.keepfight.tc.libsvm.svm_node[] x, cn.keepfight.tc.libsvm.svm_node[] y,
							 svm_parameter param)
	{
...
public class svm {
	...
	private static cn.keepfight.tc.libsvm.svm_print_interface svm_print_stdout = new cn.keepfight.tc.libsvm.svm_print_interface()
	{
	...
	private static cn.keepfight.tc.libsvm.svm_print_interface svm_print_string = svm_print_stdout;
	...
	private static void svm_binary_svc_probability(svm_problem prob, svm_parameter param, double Cp, double Cn, double[] probAB)
	{
		...
		for(i=0;i<nr_fold;i++)
		{
			...
			subprob.x = new cn.keepfight.tc.libsvm.svm_node[subprob.l][];
			...
			else
			{
				...
				cn.keepfight.tc.libsvm.svm_model submodel = svm_train(subprob,subparam);
				for(j=begin;j<end;j++)
				{
	...
	// Interface functions
	//
	public static cn.keepfight.tc.libsvm.svm_model svm_train(svm_problem prob, svm_parameter param)
	{
		cn.keepfight.tc.libsvm.svm_model model = new cn.keepfight.tc.libsvm.svm_model();
		model.param = param;
		   ...
		   param.svm_type == svm_parameter.NU_SVR)
		{
			...
			model.l = nSV;
			model.SV = new cn.keepfight.tc.libsvm.svm_node[nSV][];
		...
		else
		{
			...
			cn.keepfight.tc.libsvm.svm_node[][] x = new cn.keepfight.tc.libsvm.svm_node[l][];
			int i;
			for(i=0;i<l;i++)
				x[i] = prob.x[perm[i]];
			...
			for(i=0;i<nr_class;i++)
				for(int j=i+1;j<nr_class;j++)
				{
					...
					sub_prob.l = ci+cj;
					sub_prob.x = new cn.keepfight.tc.libsvm.svm_node[sub_prob.l][];
			...
			model.l = nnz;
			model.SV = new cn.keepfight.tc.libsvm.svm_node[nnz][];
	...
	public static void svm_cross_validation(svm_problem prob, svm_parameter param, int nr_fold, double[] target)
	{
		...
		for(i=0;i<nr_fold;i++)
		{
			...
			cn.keepfight.tc.libsvm.svm_model submodel = svm_train(subprob,param);
			if(param.probability==1 &&
	...
	public static int svm_get_svm_type(cn.keepfight.tc.libsvm.svm_model model)
	{
		return model.param.svm_type;
	}

	public static int svm_get_nr_class(cn.keepfight.tc.libsvm.svm_model model)
	{
		return model.nr_class;
	}

	public static void svm_get_labels(cn.keepfight.tc.libsvm.svm_model model, int[] label)
	{
		if (model.label != null)
	...
	public static void svm_get_sv_indices(cn.keepfight.tc.libsvm.svm_model model, int[] indices)
	{
	...
	public static int svm_get_nr_sv(cn.keepfight.tc.libsvm.svm_model model)
	{
		return model.l;
	}

	public static double svm_get_svr_probability(cn.keepfight.tc.libsvm.svm_model model)
	{
	...
	public static double svm_predict_values(cn.keepfight.tc.libsvm.svm_model model, cn.keepfight.tc.libsvm.svm_node[] x, double[] dec_values)
	{
		int i;
	...
	public static double svm_predict(cn.keepfight.tc.libsvm.svm_model model, cn.keepfight.tc.libsvm.svm_node[] x)
	{
		int nr_class = model.nr_class;
		double[] dec_values;
		if(model.param.svm_type == svm_parameter.ONE_CLASS ||
	...
	public static double svm_predict_probability(cn.keepfight.tc.libsvm.svm_model model, cn.keepfight.tc.libsvm.svm_node[] x, double[] prob_estimates)
	{
	...
	public static void svm_save_model(String model_file_name, cn.keepfight.tc.libsvm.svm_model model) throws IOException
	{
		...
		cn.keepfight.tc.libsvm.svm_node[][] SV = model.SV;
		...
		for(int i=0;i<l;i++)
		{
			...
			cn.keepfight.tc.libsvm.svm_node[] p = SV[i];
	...
	public static cn.keepfight.tc.libsvm.svm_model svm_load_model(String model_file_name) throws IOException
	{
		return svm_load_model(new BufferedReader(new FileReader(model_file_name)));
	}

	public static cn.keepfight.tc.libsvm.svm_model svm_load_model(BufferedReader fp) throws IOException
	{
		// read parameters
		...
		model.SV = new cn.keepfight.tc.libsvm.svm_node[l][];
		...
		for(int i=0;i<l;i++)
		{
			...
			model.SV[i] = new cn.keepfight.tc.libsvm.svm_node[n];
			for(int j=0;j<n;j++)
			{
				model.SV[i][j] = new cn.keepfight.tc.libsvm.svm_node();
	...
	public static int svm_check_probability_model(cn.keepfight.tc.libsvm.svm_model model)
	{
		if (((model.param.svm_type == svm_parameter.C_SVC || model.param.svm_type == svm_parameter.NU_SVC) &&
		model.probA!=null && model.probB!=null) ||
	...
	public static void svm_set_print_string_function(cn.keepfight.tc.libsvm.svm_print_interface print_func)
	{
		if (print_func == null)
